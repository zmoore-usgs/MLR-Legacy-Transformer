...
RUN export PIP_CERT="/etc/ssl/certs/ca-certificates.crt" && \
    ...
    pip3 install  --extra-index-url https://cida.usgs.gov/artifactory/api/pypi/usgs-python-${build_type}/simple -v usgs-wma-mlr-legacy-transformer==${artifact_version}
ENV bind_ip 0.0.0.0
